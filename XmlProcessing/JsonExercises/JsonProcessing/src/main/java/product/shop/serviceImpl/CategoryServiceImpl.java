...
public class CategoryServiceImpl implements CategoryService{
    ...
    @Override
    public CategoriesByProductCountXmlList findAllCyProductsCount() {
        CategoriesByProductCountXmlList result = new CategoriesByProductCountXmlList();

        result.setProducts(this.CategoriesByProductsCount());
