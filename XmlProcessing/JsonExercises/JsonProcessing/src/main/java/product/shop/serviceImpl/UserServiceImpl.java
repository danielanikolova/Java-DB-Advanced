...
public class UserServiceImpl implements UserService{
    ...
    @Override
    public SellerWithProductsXmlList findSellerList() {

        SellerWithProductsXmlList current = new SellerWithProductsXmlList();

        current.setSellerWithProductsDtoList(this.findAllUsersWithProducts());
