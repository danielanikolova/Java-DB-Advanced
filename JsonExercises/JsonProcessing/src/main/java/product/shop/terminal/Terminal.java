...
//        exportCategoriesByProductsCount();
    ...
    private  void exportUserWithAtLeastOneSoldProductCount(){
        ...
        UsersAndProductsDto result = this.userService.findUserCountAndProductInfo();

       this.jsonParser.writeObject(result, "/src/main/resources/files.out/usersCountAndProductsInfo.json");
    }
   ...
   public void importProducts(){
       ...
       ProductAddDto[] productAddDtos = this.jsonParser.getObject(ProductAddDto[].class, "/files.in/products.json");
